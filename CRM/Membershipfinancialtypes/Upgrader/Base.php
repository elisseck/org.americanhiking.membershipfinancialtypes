 ...
 */
class CRM_Membershipfinancialtypes_Upgrader_Base {
  ...
  static public function instance() {
    if (!self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_Membershipfinancialtypes_Upgrader(
        'org.americanhiking.membershipfinancialtypes',
        realpath(__DIR__ . '/../../../')
      );
    }
   ...
   *
   * @code
   * CRM_Membershipfinancialtypes_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * @endcode
   */
